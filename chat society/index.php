...
<html>  
    ...
    <body>  
			...
			<div class="group">
				...
				<div align="top-right" class="group-chat">
					<input type="hidden" id="is_active_group_chat_window" value="no" />
					<button type="button" name="group_chat" id="group_chat" class="">Group Chat</button>
          </div>
		...
		<div class="chat_message_area">
			...
			<div class="image_upload">
				<form id="uploadImage" action="upload.php" method="post" enctype="multipart/form-data">
					...
					<input type="file" name="uploadFile" id="uploadFile" accept=".jpg, .png,.jpeng,.txt,.pdf,.docx.doc" />
...
$(document).ready(function(){
	...
	$('#group_chat').click(function(){
	 if(is_admin !='')
	 {
		window.location.href='acess.php';
		return false;
	 }
